...
@Component({
  selector: 'app-manage-our-menu',
  templateUrl: './manage-our-menu.component.html',
  styleUrls: ['./manage-our-menu.component.scss']
})
export class ManageOurMenuComponent implements OnInit {
